...
def main():
    ...
    ap.add_argument("--backend", choices=["openai", "stability", "diffusers"], default="openai")
    ...
    _, items = load_prompts(args.prompts)
